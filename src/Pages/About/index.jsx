...
const peoples = [
  ...
  },
  {
    ...
    image:
      "https://i.pinimg.com/280x280_RS/4a/13/c8/4a13c8850b1c00e5d8c22146c47c6d25.jpg",
  },
  {
    name: "Jenny Wang",
  ...
  },
  {
    ...
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTQOlCnRPqYRYE_40qtuz1Vn2ghEBHG9dueTYj15jq6KN4utraWVIUvnGTt9WSMKTU97EY&usqp=CAU",
  },
  {
    name: "Daziah Turner",
    position: "Assistant Project Manager",
    image:
      "https://st3.depositphotos.com/4071389/12805/i/600/depositphotos_128051066-stock-photo-goatee-handsome-man.jpg",
  },
  {
    name: "Walter Castillo",
    position: "Administrative Manager",
    image:
      "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS-YRgrMauTguMRC9XZRpDTUZF3rnWsk2Hm5uoQAE3XsPr2044-GzhQa2ulnM_kIsPfV8Y&usqp=CAU",
  },
];
  ...
  return (
    <div>
      <div className="max-w-7xl mx-auto px-3" id="projects">
        <div className="py-3 overflow-hidden" ref={heroRef}>
          ...
          >
            <p className="text-center text-3xl">
              Noteworthy Projects We Have Worked Upon
            </p>
            <p className="text-center">
              From bespoke ERP/CRM/Management software solutions to multi-level
              web and mobile apps, implementing AI/ML to integrating IoT, we
              created what it took for our clients to reach new heights.
            </p>
          </motion.div>
        </div>
        {/* solution 01 */}
        <div className="py-5 grid grid-cols-1 md:grid-cols-2">
          <div className="col-span-1 flex flex-col-reverse md:flex-col gap-5">
            ...
            <div ref={solutionRef} className="overflow-hidden">
              <motion.div animate={solutionAnimation} className="flex gap-3">
                <div className="">
                  <img
                    src="https://www.matellio.com/solutions/wp-content/uploads/2022/04/Better-Data-Management.png"
                    alt=""
                  />
                </div>
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-gray-400">
                    Data integration, visualization, and interactions are
                    manageable from one place.
                  </p>
                </div>
              </motion.div>
            </div>
            <div ref={solutionRef2} className="overflow-hidden">
              <motion.div animate={solutionAnimation2} className="flex gap-3">
                <div className="">
                  <img
                    src="	https://www.matellio.com/solutions/wp-content/uploads/2022/02/Centralized-Dashboard-1.png"
                    alt=""
                  />
                </div>
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-gray-400">
                    A central dashboard with complete control and high-quality
            ...
            <div ref={solutionRef3} className="overflow-hidden">
              <motion.div animate={solutionAnimation3} className="flex gap-3">
                <div className="">
                  <img
                    src="https://www.matellio.com/solutions/wp-content/uploads/2022/02/Salesforce-Integration.png"
                    alt=""
                  />
                </div>
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-gray-400">
                    Salesforce makes the entire tool much better than the rest
          ...
          <div className="col-span-1 px-2 overflow-hidden" ref={solutionRef4}>
            <motion.div animate={solutionAnimation4} className="">
              <img
                src="https://www.matellio.com/solutions/wp-content/uploads/2022/07/Ostrij-Data-Integration-Solution.jpg"
                className="w-full"
                alt=""
              />
            </motion.div>
          ...
          <div className="col-span-1 flex flex-col gap-5">
            ...
            <div ref={fusionRef} className="overflow-hidden">
              <motion.div animate={fusionAnimation} className="flex gap-3">
                <div className="">
                  <img
                    src="https://www.matellio.com/solutions/wp-content/uploads/2022/02/Data-Encryption.png"
                    alt=""
                  />
                </div>
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-gray-400">
                    End-to-end data encryption to ensure secure operation at all
                    times.
                  </p>
                </div>
              </motion.div>
            ...
            <div ref={fusionRef2} className="overflow-hidden">
              <motion.div animate={fusionAnimation2} className="flex gap-3">
                <div className="">
                  <img
                    src="https://www.matellio.com/solutions/wp-content/uploads/2022/02/AI-Based-Accuracy.png"
                    alt=""
                  />
                </div>
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-gray-400">
                    AI-based accuracy in determining and managing risks/errors
                    in the system.
                  </p>
                </div>
              </motion.div>
            ...
            <div ref={fusionRef3} className="overflow-hidden">
              <motion.div animate={fusionAnimation3} className="flex gap-3">
                <div className="">
                  <img
                    src="https://www.matellio.com/solutions/wp-content/uploads/2022/02/Efficient-Workflow.png"
                    alt=""
                  />
                </div>
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-gray-400">
                    An efficient workflow ensures everyone can work at their
                    peak capacity.
                  </p>
                </div>
              </motion.div>
        ...
        <div className="py-5 grid grid-cols-1 md:grid-cols-2">
          <div className="col-span-1 flex flex-col-reverse md:flex-col gap-5">
            ...
            <div ref={patientRef} className="overflow-hidden">
              <motion.div animate={patientAnimation} className="flex gap-3">
                <div className="">
                  <img
                    src="https://www.matellio.com/solutions/wp-content/uploads/2022/03/Central-Dash-2.png"
                    alt=""
                  />
                </div>
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-gray-400">
                    A glance view of all the details of the patient required to
            ...
            <div ref={patientRef2} className="overflow-hidden">
              <motion.div animate={patientAnimation2} className="flex gap-3">
                <div className="">
                  <img
                    src="https://www.matellio.com/solutions/wp-content/uploads/2022/03/Referral-Management.png"
                    alt=""
                  />
                </div>
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-gray-400">
                    Receive fast referrals and process them based on sources,
                    easily accept/decline them.
                  </p>
                </div>
              </motion.div>
            </div>
            <div ref={patientRef3} className="overflow-hidden">
              <motion.div animate={patientAnimation3} className="flex gap-3">
                <div className="">
                  <img
                    src="https://www.matellio.com/solutions/wp-content/uploads/2022/03/HIPAA-Compliance-3-1.png"
                    alt=""
                  />
                </div>
                <div className="flex flex-col gap-2">
                  ...
                  <p className="text-gray-400">
                    All the information is stored securely and encrypted; users
                    can decide when to share it.
                  </p>
                </div>
              </motion.div>
            </div>
          ...
          <div className="col-span-1 px-2 overflow-hidden" ref={patientRef4}>
            <motion.div animate={patientAnimation4} className="">
              <img
                src="https://www.matellio.com/solutions/wp-content/uploads/2022/07/MAX-MRJ.jpg"
                className="w-full"
                alt=""
              />
            </motion.div>
        ...
        <div className="py-5">
          <p className="text-center text-3xl">
            Explore Solutions We Have Built Over the Years
          </p>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
            <div className="col-span-1 flex flex-col gap-3 py-5 px-3">
              ...
              <div className="p-2 border rounded hover:shadow-md">
                <img
                  src="https://www.matellio.com/solutions/wp-content/uploads/2022/07/mobile-app-development-338x270.jpg"
                  className="w-full"
                  alt=""
                />
              </div>
            ...
            <div className="col-span-1 flex flex-col gap-3 py-5 px-3">
              ...
              <div className="p-2 border rounded hover:shadow-md">
                <img
                  src="https://www.matellio.com/solutions/wp-content/uploads/2022/07/Dashboard.jpg"
                  className="w-full"
                  alt=""
                />
              </div>
        ...
        <div className="py-5">
          <p className="text-center text-3xl py-5">
            See What Our Customers Have to Talk About Us on Clutch
          </p>
          <div className="px-10 bg-gray-100">
            <p className="flex py-3 gap-1 font-semibold">
              All Reviews 4.8
              <span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 p-3 gap-8">
              <div className="col-span-1 flex flex-col gap-2 bg-[#fafafa] px-3 py-2 rounded-md shadow hover:shadow-lg">
                ...
                <p className="text-gray-800">
                  "The resource that worked with us were very talented and
                  iumpressive."
                </p>
