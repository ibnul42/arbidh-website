...
const portfolios = [
  {
    title: "portfolio_1",
    link: "/assets/images/portfolio/portfolio_1.png",
  },
  {
    title: "portfolio_2",
    link: "/assets/images/portfolio/portfolio_2.png",
  },
  {
    title: "portfolio_3",
    link: "/assets/images/portfolio/portfolio_3.png",
  },
  {
    title: "portfolio_4",
    link: "/assets/images/portfolio/portfolio_4.png",
  },
  {
    title: "portfolio_5",
    link: "/assets/images/portfolio/portfolio_5.png",
  },
];
...
function index() {
  return (
    <div>
      {/* slider */}
      <div className="my-5">
        <p className="font-bold text-center my-3 text-xl md:text-4xl px-10">Some of the projects we've worked on</p>
        <Carousel
          autoPlay={true}
          infiniteLoop={true}
          emulateTouch={true}
        ...
        >
          {portfolios &&
            portfolios.map((item, index) => (
              <div key={index} className="max-h-[80vh] max-w-7xl mx-auto rounded-md overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-cyan-50 to-orange-100 via-indigo-50 py-10">
        <div className="max-w-7xl mx-auto px-3 flex flex-col gap-8 items-center text-center">
          <h1 className="font-bold text-xl md:text-4xl px-10">
            <span className="text-orange-600">iOS App</span> Development
            Services
          </h1>
          <p className="md:px-20 text-xl">
            We transform our clients' ideas into flawless iOS applications
            making businesses stand out from the competition.
          </p>
          <p className="border border-indigo-500 rounded-xl py-3 px-2 md:px-5 font-semibold">
      ...
      <div className="py-10">
        <div className="max-w-7xl mx-auto px-3 flex flex-col gap-8 items-center text-center">
          <p className="font-bold text-xl md:text-4xl px-10">
            Our iOS app{" "}
            <span className="text-orange-600">development services</span>
          </p>
          <p className="text-lg">
            iOS apps are the go-to solutions for most businesses. They are
            secure and scalable. Something that can take a business ahead of
            others. Our world-class iOS developers ensure you get the best
            mobile app solution that will help you to increase your market
            reach!
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {appDevelop &&
              appDevelop.map((item, index) => (
                <div
                  key={index}
                  className="col-span-1 bg-orange-200 flex flex-col items-start gap-3 p-3 rounded-md"
                >
        ...
        <div className="max-w-7xl mx-auto px-3 grid grid-cols-12 gap-5">
          <div className="col-span-12 md:col-span-8">
            <p className="font-bold text-xl md:text-3xl">
              How do we build iOS apps that rank #1 on the App Store and get
              featured in Forbes
            </p>
          </div>
          <div className="col-span-12 md:col-span-4 flex flex-col items-center gap-3">
            ...
            <Link
              to="/contact"
              className="border-2 border-orange-500 px-10 py-3 rounded-lg bg-orange-500 hover:bg-transparent font-semibold text-white hover:text-orange-500"
            >
              Let's Talk
            </Link>
          </div>
      ...
      <div className="py-10">
        <div className="max-w-7xl mx-auto px-3 flex flex-col gap-8 items-center text-center">
          ...
          <p className="text-lg">
            iOS apps make a notable difference in business growth no other app
            can contest. Why is it so? Learn more.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {appBusiness &&
              appBusiness.map((item, index) => (
                <div
                  key={index}
                  className="col-span-1 border border-orange-500 flex flex-col items-start gap-3 py-4 px-3 rounded-md"
                >
      ...
      {/* <div className="py-10">
        <div className="max-w-7xl mx-auto px-3 flex flex-col gap-8 items-center">
          <p className="font-bold text-xl md:text-4xl px-10">
            What sets JetRuby Agency apart from other{" "}
            ...
            <div className="col-span-1 flex flex-col gap-5">
              {appBusiness &&
                appBusiness.map((item, index) => (
                  <div
                    key={index}
                    className="flex flex-col items-start gap-3 py-4 px-3 rounded-md"
                  >
                    <div className=" flex gap-2 items-center">
                      <div className="bg-orange-100 h-5 w-5 rounded-full flex justify-center items-center">
                        <div className="h-[10px] w-[10px] bg-orange-500 rounded-full"></div>
